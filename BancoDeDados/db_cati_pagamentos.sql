...
CREATE TABLE `pagamentos` (
  ...
  `statusPagamento` varchar(50) DEFAULT NULL COMMENT '{ aberto, pago, em atraso, devedor, cancelado }',
  `valorPagamento` decimal(12,2) NOT NULL,
  `observacao` text,
  PRIMARY KEY (`idPagamento`),
  KEY `idPedido` (`idPedido`),
  CONSTRAINT `pagamentos_ibfk_1` FOREIGN KEY (`idPedido`) REFERENCES `pedido` (`idPedido`)
